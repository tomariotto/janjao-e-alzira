export default function Contato() {
  return (
    <section id="contato" className="max-w-6xl mx-auto px-5 py-20 text-center">
      ...
      <h2 className="font-display text-3xl md:text-4xl text-teal-deep mb-4">Vamos conversar?</h2>
      <p className="text-lg text-teal-deep/80 mb-6 max-w-xl mx-auto">
        Dúvidas, convites para eventos, entrevistas ou parcerias — escreva direto para o autor.
      </p>
      <a
